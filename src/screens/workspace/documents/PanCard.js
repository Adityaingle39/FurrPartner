...
const PanCard = ({navigation}) => {
  ...
  const navigateButton = () => {
    if (!selectedImage) {
      Toaster({ message: `Please select PAN card from gallery.` });
      ...
      /**API Call */
      api.uploadWorkspaceDocuments(userData.id, 'PAN', form_data)
        .then(res => {
          console.log("uploadWorkspaceDocuments", res);
          setIsLoading(false);
          Toaster({ message: `PAN card submitted successfully.` });
          navigation.navigate('Verification', { uploaded: [...route.params.docs, 'doc-pan'] });
        }).catch(err => {
          setIsLoading(false);
          console.log(err);
        });
            ...
            <View>
              <View style={[documentDescription, spacingProperty['mb-20']]}>
                ...
                <Text style={[documentText, spacingProperty['pr-20'],{color:theme.colors.outline}]}>
                  Ensure that you have a clear, legible and unscanned copy of your PAN card in either JPG, JPEG, PNG.
                </Text>
              </View>
              <View style={[documentDescription, spacingProperty['mb-20']]}>
                <Icon
                  ...
                  style={spacingProperty['mr-10']}></Icon>
                <Text style={[documentText, spacingProperty['pr-20'],{color:theme.colors.outline}]}>
                Before uploading, ensure that all the details on the PAN card, such as your name, date of birth, address, and PAN number are clearly visible.
                </Text>
              </View>
              <View style={[documentDescription, spacingProperty['mb-20']]}>
                <Icon
                  ...
                  style={spacingProperty['mr-10']}></Icon>
                <Text style={[documentText, spacingProperty['pr-20'],{color:theme.colors.outline}]}>
                Ensure that your PAN card is not a black and white or grayscale scan of the original document, as these may not be accepted.
                </Text>
              </View>
              <View style={[documentDescription, spacingProperty['mb-20']]}>
                <Icon
                  ...
                  style={spacingProperty['mr-10']}></Icon>
                <Text style={[documentText, spacingProperty['pr-20'],{color:theme.colors.outline}]}>
                After uploading, check that the document has been uploaded correctly and is easily visible and readable.
                </Text>
              </View>
            </View>
            <TouchableOpacity
